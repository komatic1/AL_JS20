...
function f11() {
    ...
    document.querySelector('div.out-11').textContent = d11.indexOf(i11);
}
...
function f12() {
    ...
    for (let i = 0; i < d12.length; i++) {
        if (d12[i] == +document.querySelector('.i-12').value) {
            out = d12[i];
            break;
        } else {
            out = -1;
...
function f18() {
    ...
    document.querySelector('div.out-18').textContent = d18.includes(i18);
}
...
function f20() {
    document.querySelector('div.out-20').textContent = d20.join('');
}
