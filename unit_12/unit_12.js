...
function f2() {
    ...
    document.querySelector('div.out-2').textContent = a2[0][1];
    return a2[0][1];
}
...
function f3() {
    ...
    document.querySelector('div.out-3').textContent = a3[2][1][1];
    return a3[2][1][1];
}
...
function f4() {
    ...
    document.querySelector('div.out-4').textContent = a4[1];
    return a4[1];
}
...
function f15() {
    ...
    document.querySelector('div.out-15').textContent = max;
}
