...
function t14() {
    return a14.includes(a14_sym) || a14.includes(a14_sym.toUpperCase());
}
...
function t15() {
    a15_res = a15.filter((elem, i, arr) => {
        return elem.pnum && elem.pnum.length == 6;
    });
