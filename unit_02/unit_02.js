...
let e1 = '3',
    f1 = 5;
document.querySelector('.out-4').textContent = e1 + f1; // происходит конкатенация, потому что одна из переменных является строкой
...
function t11() {
    ...
    document.querySelector('div.out-11').textContent = data + 55;
}
...
function t12() {
    let i121 = document.querySelector('.i-12-1').value,
        i122 = document.querySelector('.i-12-2').value;
    document.querySelector('div.out-12').textContent = `Hello ${i121} ${i122}`;
}
...
function t13() {
    let i131 = document.querySelector('.i-13-1').value,
        i132 = document.querySelector('.i-13-2').value;
    document.querySelector('div.out-13').textContent = +i131 + +i132;
}
...
function t16() {
    let i161 = document.querySelector('.i-16-1').value,
        i162 = document.querySelector('.i-16-2').value;
    document.querySelector('div.out-16').textContent = i161 + i162;
}
...
function t18() {
    ...
    document.querySelector('div.out-18').textContent = parseFloat(a);
}
...
function t19() {
    let i191 = document.querySelector('.i-19-1').value,
        i192 = document.querySelector('.i-19-2').value;
    
    document.querySelector('div.out-19').textContent = +i191 + +i192;
}
...
function t20() {
    ...
    document.querySelector('div.out-20').textContent = count;
}
