...
function f2() {
    document.querySelector('div.out-2').classList.add('bg-orange');
}
...
function f3() {
    document.querySelector('div.out-3').classList.remove('bg-orange');
}
...
function f4() {
    document.querySelector('div.out-4').classList.toggle('bg-orange');
}
...
function f5() {
    document.querySelector('div.out-5').textContent = document.querySelector('div.out-4').classList.contains('bg-orange') ? true : false;
}
...
function f6() {
    document.querySelector('div.out-6').textContent = document.querySelectorAll('.p-6').length;
}
...
function f7() {
    ...
    let blocks = document.querySelectorAll('div.out-7');
    for (let i = 0; i < blocks.length; i++) {
        blocks[i].classList.add('bg-orange');
    }
}
...
function f8() {
    ...
    let blocks = document.querySelectorAll('div.out-8');
    for (let i = 0; i < blocks.length; i++) {
        blocks[i].classList.toggle('bg-orange');
    }
}
...
function f11() {
    ...
    div.textContent = 25;
    document.querySelector('div.out-11').append(div);
}
...
function f12() {
    ...
    document.querySelector('div.out-12').append(div);
}
...
function f13() {
    ...
    div.onclick = f13_1;
    document.querySelector('div.out-13').append(div);
}
...
function f14() {
    ...
    div.textContent = 14;
    div.classList.add('bg-orange');
    document.querySelector('div.out-14').append(div);
}
...
function f15() {
    ...
    div.textContent = 15;
    div.classList.add('bg-orange');
    document.querySelector('div.out-15').before(div);
}
...
function f16() {
    ...
    div.textContent = 16;
    div.classList.add('bg-orange');
    document.querySelector('div.out-16').after(div);
}
...
function f17() {
    ...
    div.textContent = 17;
    div.classList.add('bg-orange');
    document.querySelector('div.out-17').replaceWith(div);
}
...
function f18() {
    document.querySelector('div.out-18').innerHTML = document.querySelector('.p-18').getAttribute('data-b');
}
...
function f19() {
    ...
    document.querySelector('div.out-19').innerHTML = out;
}
