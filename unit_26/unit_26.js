...
function t2() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Andrey', {method:'GET'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=3&num2=13', {method:'GET'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=5&num2=10', {method:'GET'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t5() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=5', {method:'GET'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=3&num2=13', {method:'GET'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t7() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=7', {method:'GET'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t8() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1981', {method:'GET'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t9() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=9&n=1&d=1&y=1', {method:'GET'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
*/
function t10() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=1', {method:'POST'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Andrey', {method:'POST'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=5&num2=8', {method:'POST'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=3&num2=13', {method:'POST'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t14() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=5', {method:'POST'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=3&num2=13', {method:'POST'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t16() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=7', {method:'POST'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t17() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1981', {method:'POST'})
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t18() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=9&m1=&d=1&y=1', {method:'POST'})
    .then(data => {
        return data.text();
    })
    .then(data => {
