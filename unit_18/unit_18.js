...
function t4() {
    document.querySelectorAll('span.task-4').forEach(elem => {
...
function t5() {
    document.querySelectorAll('p.task-5').forEach((elem,i) => {
...
function t6() {
    let str6='helloworld';
    a6_res = str6.split();
    document.querySelector('div.out-6').textContent = a6_res.join();
}
...
function t7() {
    ...
    a7_res = str7.split(' ');
    document.querySelector('div.out-7').textContent = a7_res.join('-');
}
...
function t8() {
    ...
    document.querySelector('div.out-8').textContent = a8_res;
}
...
function t9() {
    ...
    document.querySelector('div.out-9').textContent = a9_res;
}
...
function t10() {
    ...
    document.querySelector('div.out-10').textContent = a10_res;
}
