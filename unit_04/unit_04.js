...
function f1() {
    document.querySelector('div.out-1').textContent = 1;
}
...
function f2() {
    document.querySelector('div.out-2').textContent = 2;
}
...
function f3() {
    document.querySelector('div.out-3').textContent = 3;
}
...
function f5() {
    let i5 = document.querySelector('.i-5'),
        out5 = document.querySelector('div.out-5');
...
function f6() {
    document.querySelector('div.out-6').textContent = document.querySelector('.i-6').value;
}
...
function f7() {
    let i7 = document.querySelector('.i-7').value,
        out71 = document.querySelector('div.out-71'),
        out72 = document.querySelector('div.out-72');
...
function f9() {
    let r9 = document.querySelector('.r-9'),
        out9 = document.querySelector('div.out-9');
...
function f10() {
    document.querySelector('div.out-10').style.background = document.querySelector('.i-10').value;
}
...
function f12() {
    document.querySelector('div.out-12').textContent = document.querySelector('.i-12').value;
}
...
function f13() {
    document.querySelector('div.out-13').textContent = document.querySelector('.i-13').value;
}
...
function f14() {
    document.querySelector('div.out-14').textContent = document.querySelector('.t-14').value;
}
...
function f15() {
    ...
    document.querySelector('div.out-15').textContent = i15;
}
...
function f16() {
    ...
    document.querySelector('div.out-16').textContent = document.querySelector('.s-16').value;
}
...
function f17() {
    document.querySelector('div.out-17').textContent = document.querySelector('.s-17').value;
}
