...
function f11() {
    let out = '',
        i = document.querySelector('.i-11').value;
...
function f12() {
   let out = '',
        i = +document.querySelector('.i-12').value;
...
function f16() {
    ...
    document.querySelector('div.out-16').textContent = out;
}
...
let out = '';
    ...
    document.querySelector('div.out-17').textContent = out;
}
...
function f18() {
let out = '',
    i = document.querySelector('.i-18').value;
...
function f19() {
let out = '',
    i = document.querySelector('.i-19').value;
    i = i[0].toUpperCase() + i.substring(1);

    for (let key in a19) {
        if (a19[key].indexOf(i) != -1) {
            out = key;
            break;
        } else {
            out = '';
