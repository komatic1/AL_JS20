...
let ar3 =  [13, 3, 9]; // переменную обьявляем здесь!!!!

function f3() {
    document.querySelector('div.out-3').textContent = ar3.length;
}
...
function f4() {
    document.querySelector('div.out-4').textContent = `${ar4[0]} ${ar4[3]} ${ar4[8]}`;
}
...
function f5() {
    document.querySelector('div.out-5').textContent = ar5[0] + ar5[2] + ar5[3];
}
...
function f8() {
    ...
    document.querySelector('div.out-8-1').textContent = ar8.length;
}
...
function f9() {
    document.querySelector('div.out-9').textContent = ar9[ar9.length - 1];
}
...
function f10() {
    document.querySelector('div.out-10').textContent = ar10[0] + ar10[ar10.length - 1];
}
...
function f11() {
    let out = '';
    ar11[2] = ar11[2] + ar11[4];
    ar11[4] = ar11[2] - ar11[4];
    ar11[2] = ar11[2] - ar11[4];
...
function f12() {
    ...
    document.querySelector('div.out-12').textContent = out;
}
...
function f13() {
    ...
    document.querySelector('div.out-13').textContent = out;
}
...
function f16() {
    ...
    for (let j = 0; j < ar16_odd.length; j++) {
        odd += `${ar16_odd[j]} `;
    }

    document.querySelector('div.out-16-odd').textContent = odd;
    document.querySelector('div.out-16-even').textContent = even;
}
...
function f17() {
    ...
    document.querySelector('div.out-17').textContent = count;
}
...
function f18() {
    ...
    document.querySelector('div.out-18').textContent = out;
}
...
function f19() {
    ...
    document.querySelector('div.out-19').textContent = out;
}
...
function f20() {
    ...
    document.querySelector('div.out-20').textContent = out;
}
