...
function t3() {
    ...
    try {
        ...
        document.querySelector('.b-3').parentNode.append(div);
    }
}
...
function t4() {
    try {
        a.push(7);
        document.querySelector('div.out-4').textContent = a.join(' ');
    } catch {
        document.querySelector('div.out-4').textContent = 0;
    }
}
...
function t5() {
    ...
    try {
        ...
        document.querySelector('div.out-5').textContent = 0;
    } finally {
        document.querySelector('div.out-5-1').textContent = 'finnaly';
    }
}
