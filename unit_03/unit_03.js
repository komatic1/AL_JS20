...
function f1(){
   let i1 = +document.querySelector('.i-1').value,
       out1 = document.querySelector('div.out-1');
   if (i1 == 4) {
...
function f2(){
   let out2 = document.querySelector('div.out-2');
   if (a21 > a22) {
...
function f3(){
   let i31 = +document.querySelector('.i-31').value,
       ...
       out3 = document.querySelector('div.out-3');
   if (i31 > i32) {
...
function f4(){
   let i4 = +document.querySelector('.i-4').value,
       out4 = document.querySelector('div.out-4'),
       curYear = new Date();

   if (i4 > curYear.getFullYear() || curYear.getFullYear() - i4 < 18) {
      out4.textContent = 0;
   } else {
      out4.textContent = 1;
   }
...
function f6(){
   let i6 = +document.querySelector('.i-6').value,
       out6 = document.querySelector('div.out-6');
   if (i6 % 2 == 0) {
...
function f7(){
   ...
   document.querySelector('div.out-7').textContent = i71**i72;
}
...
function f8(){
   let s8 = +document.querySelector('.s-8').value,
       out8 = document.querySelector('div.out-8');
...
function f10(){
   document.querySelector('div.out-10').textContent = document.querySelector('.s-100').value;
}
...
function f11(){
   document.querySelector('div.out-11').textContent = document.querySelector('.s-110').value;
}
...
function f13(){
   ...
   document.querySelector('div.out-13').textContent = (typeof i130);
}
...
function f14(){
   let i141 = +document.querySelector('.i-141').value,
       i142 = +document.querySelector('.i-142').value,
       s143 = document.querySelector('.s-143').value,
       out14 = document.querySelector('div.out-14');
...
function f15(){
   let s151 = +document.querySelector('.s-151').value,
       s152 = +document.querySelector('.s-152').value,
       s153 = document.querySelector('.s-153').value,
       out15 = document.querySelector('div.out-15');
