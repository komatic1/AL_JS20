...
const f5 = () => {
    document.querySelector('div.out-5').textContent = s5.size;
}
...
const f6 = () => {
    ...
    document.querySelector('div.out-6').textContent = a.size;
}
...
const f7 = () => {
    ...
    for (let k = 0; k < i.split('').length; k++) {
        pass.add(i[k]);
    }
